...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Apr 28 13:10:47 BRT 2019
  */
...
class CUP$parser$actions {
    ...
    public TypeIF getType(String identifier){
                ...
                TypeTableIF typeTable = scope.getTypeTable();
                if(typeTable.containsType(identifier)) {
                    return typeTable.getType(identifier);
                }
	...
	public void addType(String identifier, TypeIF type){
        ...
        syntaxErrorManager.syntaxInfo("Added type " + identifier);
	}
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		Token identificador = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
                   ...
                   //Add simple types
                   addType("boolean", new TypeSimple(getCurrentScope()));
                   addType("int", new TypeSimple(getCurrentScope()));
