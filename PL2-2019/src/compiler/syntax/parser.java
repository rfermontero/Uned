...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon May 20 09:13:07 BRT 2019
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		ParFuncion parFuncion = (ParFuncion)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                      ...
                      if(((SymbolProcedure)symbol).getCabProcedure().getProcParemParam().getProcListParam().getProcListParam().size()==0){
                        cb.addQuadruple("PARAM");
                      } 
		...
		Token identificador = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                    ...
                    LabelIF l1 = lf.create(identificador.getLexema());
		                Procedure procedure = new Procedure(identificador.getLexema(), getCurrentScope(), symbol);
                    cb.addQuadruple("CALL", procedure);

                    if(((SymbolProcedure)symbol).getCabProcedure().getProcParemParam().getProcListParam()==null){
                       cb.addQuadruple("PARAM");
                    }
    	...
    	Map<String, SymbolProcedure> functions = new HashMap<String, SymbolProcedure>();
          ...
          for (TemporalIF scopeTemporal: scopeTemporals) {
            if (scope.getLevel() == 0) {
              ...
              if(functions.get(scopeTemporal.getScope().getName())!=null){
