...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Apr 28 13:43:10 BRT 2019
  */
...
class CUP$parser$actions {
    ...
    public TypeIF getType(String identifier) {
        	    ScopeIF scope = scopeManager.getCurrentScope();
                TypeTableIF typeTable = scope.getTypeTable();
                System.out.println("Searching type " + identifier + " in table " + typeTable);
	...
	public void addSymbol(String identifier, SymbolIF symbol){
        ...
        syntaxErrorManager.syntaxInfo("Added symbol " + identifier + " in " + scope + " and table " + symbolTable);
	}
	...
	public void addType(String identifier, TypeIF type){
        ...
        syntaxErrorManager.syntaxInfo("Added type " + identifier + " in " + scope + " and table " + typeTable);
	}
