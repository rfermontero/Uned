...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat May 04 14:19:29 BRT 2019
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		StmSubprogram stmSubprogram = (StmSubprogram)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                  ...
                  stmSubprogram = stmSubprogram.addCuerpoAndProcedure(cuerpo, cabProcedure);
                                      System.out.println(stmSubprogram);
		...
		Sentencias sentencias = (Sentencias)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
                  ...
                  if(stmSubprogram.getCuerpo()!=null && stmSubprogram.getCabProcedure()!=null) {
                    checkSymbolDoesNotExists(stmSubprogram.getCabProcedure().getIdentificador());
                    SymbolIF symbol  = null;

                    if(stmSubprogram.getCabProcedure().getTipoRetorno().getIntOBool() == null) {//Is function
                        symbol = new SymbolFunction(getCurrentScope(), stmSubprogram.getCabProcedure().getIdentificador(),
                            stmSubprogram, new TypeFunction(getCurrentScope()));
                    } else {
                        symbol = new SymbolProcedure(getCurrentScope(), stmSubprogram.getCabProcedure().getIdentificador(),
                            stmSubprogram, new TypeFunction(getCurrentScope()));
                    }

                     addSymbol(stmSubprogram.getCabProcedure().getIdentificador(), symbol);
